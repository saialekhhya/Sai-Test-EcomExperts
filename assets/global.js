...
class VariantSelects extends HTMLElement {
  ...
  // it filters media items in an image gallery or slider based on the currently selected product variant.
  filterMedia() {
  ...
  // the above code filters media, this code updates media 
  updateMedia() {
